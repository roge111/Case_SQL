...
мы устанавливаем `name_value` = 'Выручка_без_WB' и k = 1/0.83. В условии дана информация, что у нас в (Заказано, себестоимость) указана выручка с учетом комиссии 17%.
...
Тут `categories_cost_place` — список категорий, `minimum` — это минимальная фикс. цена.
...
Спасибо за вниамание! Надеюсь, было инетерсно
